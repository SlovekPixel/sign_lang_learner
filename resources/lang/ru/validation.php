...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'available'             => 'Доступно',
        'size'                  => 'Размер',
        'drive_front'           =>  'Фото прав(1 сторона)',
        'drive_back'            =>  'Фото прав(2 сторона)',
        'passport_front'        =>  'Фото паспорта(1 сторона)',
        'passport_back'         =>  'Фото паспорта(2 сторона)',
        'sts_front'             =>  'Фото СТС(1 сторона)',
        'sts_back'              =>  'Фото СТС(2 сторона)',
        'inn'                   =>  'ИНН',
        'agency_name'           =>  'Название организации',
        'ogrn'                  =>  'ОГРН',
        'ogrn_image'                  =>  'Фото ОГРН',
        'passport_series'       =>  'Серия паспорта',
        'passport_number'       =>  'Номер паспорта',
        //custom

        'load_full_address'          => 'Населенный пункт загрузки',
        'load_region'                => 'Регион загрузки',
        'load_city'                  => 'Город загрузки',
        'load_area'                  => 'Район загрузки',
        'load_settlement'            => 'Населенный пункт загрузки',
        'load_street'                => 'Улица загрузки',
        'load_house'                 => 'Строение загрузки',
        'load_lat'                   => 'Широта загрузки',
        'load_lon'                   => 'Долгота загрузки ',
        'load_place'                 => 'Организация загрузки (место)',
        
        'unload_full_address'        => 'Населенный пункт выгрузки',
        'unload_region'              => 'Регион выгрузки',
        'unload_city'                => 'Город выгрузки',
        'unload_area'                => 'Район выгрузки',
        'unload_settlement'          => 'Населенный пункт выгрузки',
        'unload_street'              => 'Улица выгрузки',
        'unload_house'               => 'Строение выгрузки',
        'unload_lat'                 => 'Широта выгрузки',
        'unload_lon'                 => 'Долгота выгрузки ',
        'unload_place'               => 'Организация выгрузки (место)',

        'exporter'                   => 'Экспортер',
        'distance'                   => 'Дистанция',
        'date_start'                 => 'Дата начала погрузки',
        'date_end'                   => 'Дата окончания погрузки',
        'max_scale'                  => 'Грузопдъемность весов',
        'max_shortage'               => 'Допустимая недосдача',
        'culture_id'                 => 'Культура',
        'loading_id'                 => 'Способ погрузки',
        'allow_call_me'              => 'Разрешить звонок',
        'without_tender'             => 'Без торга',
        'stand'                      => 'Простой',
        'cost'                       => 'Цена за кг',
        'amount'                     => 'Объем перевозки',
        'information'                => 'Дополнительное описание',
        'stand_day'                  => 'Начало оплаты простоя',
